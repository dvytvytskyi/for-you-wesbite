      ...
      try {
        ...
        const convertedAreas: Area[] = apiAreas
          ...
          .map(area => {
            ...
            if (!imageUrl || imageUrl.trim() === '' || imageUrl === 'https://res.cloudinary.com/dgv0rxd60/image/upload/f_auto,q_auto:eco,w_800/v1768389724/golf.jpg') {
              imageUrl = 'https://res.cloudinary.com/dgv0rxd60/image/upload/f_auto,q_auto:eco,w_800/v1768389724/golf.jpg';
            } else {
              ...
              if (Array.isArray(imageUrl)) {
                imageUrl = imageUrl[0] || 'https://res.cloudinary.com/dgv0rxd60/image/upload/f_auto,q_auto:eco,w_800/v1768389724/golf.jpg';
              }
              ...
              if (typeof imageUrl !== 'string' || (!imageUrl.startsWith('http') && imageUrl !== 'https://res.cloudinary.com/dgv0rxd60/image/upload/f_auto,q_auto:eco,w_800/v1768389724/golf.jpg')) {
                // REMOVED: Too much logging
                imageUrl = 'https://res.cloudinary.com/dgv0rxd60/image/upload/f_auto,q_auto:eco,w_800/v1768389724/golf.jpg';
              }
            }
                      ...
                      <div className={styles.cardImage}>
                        ...
                        <Image
                          src={(() => {
                            ...
                            if (!src || typeof src !== 'string' || src.trim() === '' || src === 'https://res.cloudinary.com/dgv0rxd60/image/upload/f_auto,q_auto:eco,w_800/v1768389724/golf.jpg') {
                              src = 'https://res.cloudinary.com/dgv0rxd60/image/upload/f_auto,q_auto:eco,w_800/v1768389724/golf.jpg';
                            } else {
                              // Clean the URL
                              src = src.trim();
                              ...
                              if (src !== 'https://res.cloudinary.com/dgv0rxd60/image/upload/f_auto,q_auto:eco,w_800/v1768389724/golf.jpg') {
                            ...
                            if (src !== 'https://res.cloudinary.com/dgv0rxd60/image/upload/f_auto,q_auto:eco,w_800/v1768389724/golf.jpg' && (!src.startsWith('http') || src.length < 10)) {
                              src = 'https://res.cloudinary.com/dgv0rxd60/image/upload/f_auto,q_auto:eco,w_800/v1768389724/golf.jpg';
                            }
                          ...
                          unoptimized={(() => {
                            ...
                            if (!src || src === 'https://res.cloudinary.com/dgv0rxd60/image/upload/f_auto,q_auto:eco,w_800/v1768389724/golf.jpg' || !src.startsWith('http')) {
                          ...
                          onError={(e) => {
                            ...
                            if (target && target.src !== 'https://res.cloudinary.com/dgv0rxd60/image/upload/f_auto,q_auto:eco,w_800/v1768389724/golf.jpg') {
                              target.src = 'https://res.cloudinary.com/dgv0rxd60/image/upload/f_auto,q_auto:eco,w_800/v1768389724/golf.jpg';
                              // Also update the area's image in state to prevent retries
                              setAllAreas(prev => prev.map(a =>
                                a.id === area.id ? { ...a, image: 'https://res.cloudinary.com/dgv0rxd60/image/upload/f_auto,q_auto:eco,w_800/v1768389724/golf.jpg' } : a
                              ));
                            }
                            setImagesLoading(prev => {
                              const next = new Set(prev);
