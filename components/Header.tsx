...
function HeaderContent() {
  ...
  return (
    <header className={`${styles.header} ${isScrolled ? styles.scrolled : ''} ${!isHomePage ? styles.alwaysWhite : ''}`}>
      ...
      {/* Normal Header Content (hidden on properties mobile) */}
      <div className={`${styles.container} ${isPropertiesPage ? styles.hideOnPropertiesMobile : ''}`}>
        <button
        ...
        <nav className={styles.authNav}>
          <Link href={getLocalizedPath('/favorites')} className={`${styles.glassButton} ${styles.register}`}>
            {t('likes')} ({favorites.length})
          </Link>
          <div className={styles.languageSwitcher}>
            <button onClick={() => switchLanguage('en')} className={`${styles.languageButton} ${locale === 'en' ? styles.languageButtonActive : ''}`}>EN</button>
            <button onClick={() => switchLanguage('ru')} className={`${styles.languageButton} ${locale === 'ru' ? styles.languageButtonActive : ''}`}>RU</button>
          </div>
        </nav>
